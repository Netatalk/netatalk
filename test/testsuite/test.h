...
extern unsigned int FPByteLock(CONN *conn, uint16_t fork, int end, int mode,
                               int offset, int size);
extern unsigned int FPByteLock_ext(CONN *conn, uint16_t fork, int end, int mode,
...
extern unsigned int FPEnumerate(CONN *conn, uint16_t vol, int did, char *name,
                                uint16_t f_bitmap, uint16_t d_bitmap);
extern unsigned int FPEnumerateFull(CONN *conn, uint16_t vol, uint16_t sindex,
                                    uint16_t reqcnt, uint16_t size,
                                    int did, char *name, uint16_t f_bitmap, uint16_t d_bitmap);

extern unsigned int FPGetFileDirParams(CONN *conn, uint16_t vol, int did,
                                       char *name, uint16_t f_bitmap, uint16_t d_bitmap);
extern unsigned int FPEnumerate_ext(CONN *conn, uint16_t vol, int did,
                                    char *name, uint16_t f_bitmap, uint16_t d_bitmap);
extern unsigned int FPEnumerate_ext2(CONN *conn, uint16_t vol, int did,
                                     char *name, uint16_t f_bitmap, uint16_t d_bitmap);
extern unsigned int FPEnumerateExt2Full(CONN *conn, uint16_t vol, uint32_t did,
                                        char *name, uint16_t f_bitmap, uint16_t d_bitmap, uint32_t startindex,
                                        uint16_t reqcount);
...
extern uint16_t    FPOpenFork(CONN *conn, uint16_t vol, int type,
                              uint16_t bitmap, int did, char *name, int access);
extern unsigned int FPCreateFile(CONN *conn, uint16_t vol, char type, int did,
                                 char *name);
extern unsigned int FPGetForkParam(CONN *conn, uint16_t fork, uint16_t bitmap);
extern unsigned int FPCopyFile(CONN *conn, uint16_t svol, int sdid,
                               uint16_t dvol, int ddid, char *src, char *dstdir, char *dst);
extern unsigned int FPExchangeFile(CONN *conn, uint16_t vol, int sdid, int ddid,
                                   char *src, char *dst);

extern unsigned int FPMoveAndRename(CONN *conn, uint16_t svol, int sdid,
                                    int ddid, char *src, char *dst);
...
extern unsigned int FPRead_ext(CONN *conn, uint16_t fork, off_t offset,
...
extern unsigned int FPWrite_ext_async(CONN *conn, uint16_t fork, off_t  offset,
                                      off_t size, char *data, char whence);

extern unsigned int FPSetForkParam(CONN *conn, uint16_t fork,  uint16_t bitmap,
                                   off_t size);

extern unsigned int FPGetComment(CONN *conn, uint16_t vol, int did, char *name);
extern unsigned int FPRemoveComment(CONN *conn, uint16_t vol, int did,
                                    char *name);
extern unsigned int FPAddComment(CONN *conn, uint16_t vol, int did, char *name,
                                 char *cmt);

extern unsigned int FPGetVolParam(CONN *conn, uint16_t vol, uint16_t bitmap);
extern unsigned int FPSetVolParam(CONN *conn, uint16_t vol, uint16_t bitmap,
                                  struct afp_volume_parms *parms);

extern unsigned int FPGetUserInfo(CONN *conn, char flag, int id,
                                  uint16_t bitmap);

extern unsigned int FPSetDirParms(CONN *conn, uint16_t vol, int did, char *name,
                                  uint16_t bitmap,
                                  struct afp_filedir_parms *dir);
extern unsigned int FPSetFilDirParam(CONN *conn, uint16_t vol, int did,
                                     char *name, uint16_t bitmap,
                                     struct afp_filedir_parms *fil);

extern unsigned int FPSetFileParams(CONN *, uint16_t vol, int did, char *name,
                                    uint16_t bitmap, struct afp_filedir_parms *);
...
extern unsigned int FPResolveID(CONN *conn, uint16_t vol, int did,
                                uint16_t bitmap);

extern unsigned int FPAddIcon(CONN *conn, uint16_t dt, char *creator,
                              char *type, char itype, uint32_t tag,
                              uint16_t size, char *data);
extern unsigned int FPGetIcon(CONN *conn, uint16_t dt, char *creator,
                              char *type, char itype, uint16_t size);
extern unsigned int FPGetIconInfo(CONN *conn, uint16_t dt,
                                  unsigned char *creator, uint16_t itype);

extern unsigned int FPGetAppl(CONN *conn, uint16_t dt, char *name,
                              uint16_t index, uint16_t f_bitmap);
extern unsigned int FPAddAPPL(CONN *conn, uint16_t dt, int did, char *creator,
                              uint32_t tag, char *name);
extern unsigned int FPRemoveAPPL(CONN *conn, uint16_t dt, int did,
                                 char *creator, char *name);

extern unsigned int FPCatSearch(CONN *conn, uint16_t vol, uint32_t  nbe,
                                char *pos, uint16_t f_bitmap, uint16_t d_bitmap,
                                uint32_t rbitmap, struct afp_filedir_parms *filedir,
                                struct afp_filedir_parms *filedir2);

extern unsigned int FPCatSearchExt(CONN *conn, uint16_t vol, uint32_t  nbe,
                                   char *pos, uint16_t f_bitmap, uint16_t d_bitmap,
                                   uint32_t rbitmap, struct afp_filedir_parms *filedir,
                                   struct afp_filedir_parms *filedir2);
...
extern unsigned int FPGetACL(CONN *conn, uint16_t svol, int did,
                             uint16_t bitmap, char *name);
extern unsigned int FPGetExtAttr(CONN *conn, uint16_t vol, int did,
                                 uint16_t bitmap, uint16_t maxsize, char *name, char *attr);
extern unsigned int FPListExtAttr(CONN *conn, uint16_t vol, int did,
                                  uint16_t bitmap, int maxsize, char *name);
extern unsigned int FPSetExtAttr(CONN *conn, uint16_t vol, int did,
                                 uint16_t bitmap, char *name, char *attr, char *data);
extern unsigned int FPRemoveExtAttr(CONN *conn, uint16_t vol, int did,
