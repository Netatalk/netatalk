...
unsigned int local_writeheader(DSI *dsi, uint16_t fork, off_t offset,
                               size_t size, char *data, char whence);
unsigned int local_writefooter(DSI *dsi, uint16_t fork, off_t offset,
                               size_t size, char *data, char whence);
...
unsigned int local_read(CONN *conn, uint16_t fork, long long offset, int size,
                        char *data);
unsigned int local_readheader(DSI *dsi, uint16_t fork, off_t offset,
                              size_t size, char *data);
unsigned int local_readfooter(DSI *dsi, uint16_t fork, off_t offset,
                              size_t size, char *data);
...
struct vfs {
    ...
    unsigned int (*writeheader)(DSI *, uint16_t, off_t, size_t, char *, char);
    unsigned int (*writefooter)(DSI *, uint16_t, off_t, size_t, char *, char);
    ...
    unsigned int (*readheader)(DSI *, uint16_t, off_t, size_t, char *);
    unsigned int (*readfooter)(DSI *, uint16_t, off_t, size_t, char *);
