...
static void usage_mv(void)
{
    printf(
        ...
        "The mv utility moves files and directories in an AFP volume.\n"
        "The corresponding CNIDs are updated in the volume's database,\n"
        "and AppleDouble metadata is moved accordingly.\n"
        "If source and destination are on different volumes,\n"
