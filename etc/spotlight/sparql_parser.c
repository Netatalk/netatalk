...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_FUNC_INRANGE = 5,               /* FUNC_INRANGE  */
  YYSYMBOL_DATE_ISO = 6,                   /* DATE_ISO  */
  YYSYMBOL_OBRACE = 7,                     /* OBRACE  */
  YYSYMBOL_CBRACE = 8,                     /* CBRACE  */
  YYSYMBOL_EQUAL = 9,                      /* EQUAL  */
  YYSYMBOL_UNEQUAL = 10,                   /* UNEQUAL  */
  YYSYMBOL_GT = 11,                        /* GT  */
  YYSYMBOL_LT = 12,                        /* LT  */
...
{
       0,    72,    72,    74,    78,    92,   103,   111,   112,   113,
     114,   121,   136,   137,   138,   139,   140,   141,   142,   143,
     147,   151,   152
};
#endif
...
{
  "\"end of file\"", "error", "\"invalid token\"", "WORD", "BOOL",
  "FUNC_INRANGE", "DATE_ISO", "OBRACE", "CBRACE", "EQUAL", "UNEQUAL", "GT",
  "LT", "COMMA", "QUOTE", "AND", "OR", "$accept", "input", "line", "expr",
  "match", "function", "date", YY_NULLPTR
};
...
#line 78 "sparql_parser.y"
    ...
    ssp_result = talloc_asprintf(ssp_slq,
                                 ...
                                 (yyvsp[0].sval), ssp_slq->slq_scope, result_limit);
    (yyval.sval) = ssp_result;
}
#line 1523 "sparql_parser.c"
    break;

  case 5: /* expr: BOOL  */
#line 92 "sparql_parser.y"
     {
	/*
...
#line 1539 "sparql_parser.c"
    break;

  case 6: /* expr: match OR match  */
#line 103 "sparql_parser.y"
                                 {
    if ((yyvsp[-2].sval) == NULL || (yyvsp[0].sval) == NULL)
        YYABORT;
    if (strcmp((yyvsp[-2].sval), (yyvsp[0].sval)) != 0)
        (yyval.sval) = talloc_asprintf(ssp_slq, "{ %s } UNION { %s }", (yyvsp[-2].sval), (yyvsp[0].sval));
    else
        (yyval.sval) = talloc_asprintf(ssp_slq, "%s", (yyvsp[-2].sval));
}
#line 1552 "sparql_parser.c"
    break;

  case 7: /* expr: match  */
#line 111 "sparql_parser.y"
                               {(yyval.sval) = (yyvsp[0].sval); if ((yyval.sval) == NULL) YYABORT;}
#line 1558 "sparql_parser.c"
    break;

  case 8: /* expr: function  */
#line 112 "sparql_parser.y"
                               {(yyval.sval) = (yyvsp[0].sval);}
#line 1564 "sparql_parser.c"
    break;

  case 9: /* expr: OBRACE expr CBRACE  */
#line 113 "sparql_parser.y"
                               {(yyval.sval) = talloc_asprintf(ssp_slq, "%s", (yyvsp[-1].sval));}
#line 1570 "sparql_parser.c"
    break;
...
#line 114 "sparql_parser.y"
    ...
    (yyval.sval) = talloc_asprintf(ssp_slq, "%s . %s", (yyvsp[-2].sval), (yyvsp[0].sval));
}
#line 1582 "sparql_parser.c"
    break;
...
#line 1599 "sparql_parser.c"
    break;

  case 12: /* match: WORD EQUAL QUOTE WORD QUOTE  */
#line 136 "sparql_parser.y"
                                {(yyval.sval) = map_expr((yyvsp[-4].sval), '=', (yyvsp[-1].sval));}
#line 1605 "sparql_parser.c"
    break;

  case 13: /* match: WORD UNEQUAL QUOTE WORD QUOTE  */
#line 137 "sparql_parser.y"
                                {(yyval.sval) = map_expr((yyvsp[-4].sval), '!', (yyvsp[-1].sval));}
#line 1611 "sparql_parser.c"
    break;

  case 14: /* match: WORD LT QUOTE WORD QUOTE  */
#line 138 "sparql_parser.y"
                                {(yyval.sval) = map_expr((yyvsp[-4].sval), '<', (yyvsp[-1].sval));}
#line 1617 "sparql_parser.c"
    break;

  case 15: /* match: WORD GT QUOTE WORD QUOTE  */
#line 139 "sparql_parser.y"
                                {(yyval.sval) = map_expr((yyvsp[-4].sval), '>', (yyvsp[-1].sval));}
#line 1623 "sparql_parser.c"
    break;

  case 16: /* match: WORD EQUAL QUOTE WORD QUOTE WORD  */
#line 140 "sparql_parser.y"
                                      {(yyval.sval) = map_expr((yyvsp[-5].sval), '=', (yyvsp[-2].sval));}
#line 1629 "sparql_parser.c"
    break;

  case 17: /* match: WORD UNEQUAL QUOTE WORD QUOTE WORD  */
#line 141 "sparql_parser.y"
                                     {(yyval.sval) = map_expr((yyvsp[-5].sval), '!', (yyvsp[-2].sval));}
#line 1635 "sparql_parser.c"
    break;

  case 18: /* match: WORD LT QUOTE WORD QUOTE WORD  */
#line 142 "sparql_parser.y"
                                    {(yyval.sval) = map_expr((yyvsp[-5].sval), '<', (yyvsp[-2].sval));}
#line 1641 "sparql_parser.c"
    break;

  case 19: /* match: WORD GT QUOTE WORD QUOTE WORD  */
#line 143 "sparql_parser.y"
                                    {(yyval.sval) = map_expr((yyvsp[-5].sval), '>', (yyvsp[-2].sval));}
#line 1647 "sparql_parser.c"
    break;

  case 20: /* function: FUNC_INRANGE OBRACE WORD COMMA date COMMA date CBRACE  */
#line 147 "sparql_parser.y"
                                                      {(yyval.sval) = map_daterange((yyvsp[-5].sval), (yyvsp[-3].tval), (yyvsp[-1].tval));}
#line 1653 "sparql_parser.c"
    break;

  case 21: /* date: DATE_ISO OBRACE WORD CBRACE  */
#line 151 "sparql_parser.y"
                               {(yyval.tval) = isodate2unix((yyvsp[-1].sval));}
#line 1659 "sparql_parser.c"
    break;
