...
A zero-configuration database backend, equivalent to the dbd backend.
It uses the SQLite v3 engine and stores its database files under
*netatalk/CNID/sqlite* in the system state directory.
