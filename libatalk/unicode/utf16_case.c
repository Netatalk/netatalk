/*
  ...
  Based on data published by the Unicode Consortium:
...
uint32_t toupper_sp(uint32_t val) {
    ...
    if (val >= 0xD803DD40 && val <= 0xD803DD7F) {
        return upper_table_sp_5[val - 0xD803DD40];
    }

    if (val >= 0xD803DD40 && val <= 0xD803DDBF) {
        return upper_table_sp_6[val - 0xD803DD40];
    }

    if (val >= 0xD806DCC0 && val <= 0xD806DCFF) {
        return upper_table_sp_7[val - 0xD806DCC0];
    }
...
uint32_t tolower_sp(uint32_t val) {
    ...
    if (val >= 0xD803DD40 && val <= 0xD803DD7F) {
        return lower_table_sp_6[val - 0xD803DD40];
    }

    if (val >= 0xD806DC80 && val <= 0xD806DCBF) {
        return lower_table_sp_7[val - 0xD806DC80];
    }
