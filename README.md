...
See the [Webmin module reame](https://github.com/Netatalk/netatalk/blob/main/contrib/webmin_module/README.md)
...
to learn coding standards and how to prepare a PR that is compliant with project guidelines.
