...
#define OPTION_SINGLEUSER   (1 << 19) /*!< single-user server without root privileges */
...
typedef struct AFPObj {
    ...
    int afp_version;
    int cnx_cnt, cnx_max;
    int vols_skipped; /*!< volume sections the last load_afp_conf_vols() could not turn into volumes */
    /* Functions */
    void (*logout)(void);
    void (*exit)(int);
    int (*reply)(void *, int);
